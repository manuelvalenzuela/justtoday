...
- Production Google OAuth redirect URI registered: `https://justtoday-app-<suffix>.azurewebsites.net/api/auth/callback/google` (alongside the localhost URI from P3).
